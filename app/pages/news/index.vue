  ...
  <div>
    ...
    <UMain>
      <div class="py-6 md:py-10 lg:py-12 px-4 mx-auto" style="max-width: 1408px">
        ...
        <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#222E31] mb-3 md:mb-4">Featured News</h1>
...
const { data: headlines } = useHeadlinesData(API_ENDPOINTS.HEADLINES, page);
